...
module Jekyll
  ...
  class AlternateText< Liquid::Block
    ...
    def render(context)
      ...
      %{<div class="alternate-text" style="display:none">#{blockquote}</div>}
    end
...
Liquid::Template.register_tag('alternatetext', Jekyll::AlternateText)
